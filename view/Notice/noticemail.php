          ...
          <div class="portlet box green">
            ...
            <div class="panel panel-default">      
                <div class="panel-body">
                      ...
                      <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                            ...
                            <div class="form-group">
                                <label for="SecurityRecommendations">Address</label><br>
                                <input type="text" class="form-control mainheading" id="mail" value="<?php echo $pawndata[0]['mail']?>" readonly>
                            </div>          
                            </div> 
                            </div>
                            </div>
            ...
            <div class="panel panel-default">      
             ...
             <div class="modal-footer" style="border-top: 1px solid #eef1f5;margin-top: 30px;">
                ...
                <button type="button"  onclick="sendmailnotice()" data-dismiss="modal" class="btn btn-primary" style="background-color:#4285f4; float:right;margin-left:15px;">Notice Mail</button>          
                    </div> 
