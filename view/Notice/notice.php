                  ...
                  <tbody>
                   <?php foreach ($pClosed as $dat) { ?>
                    <tr>
                      ...
                      <td><button class="btn btn-primary" style="background: #8e44ad"><a style="color: #fdfdfd;" href="/Jeweller/view/Notice/noticemail.php?id=<?php echo $dat['id']; ?>">Notice</a></button></td>
                    </tr>
                   <?php } ?> 
                  </tbody>
                                    </table>
