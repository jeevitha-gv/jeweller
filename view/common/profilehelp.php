...
<li style="font-family: Verdana;font-size: 17px !important;">The top portion shows the User feeds and the overall tasks assigned for the users as well the user logs and the time line feature.</li>
</ul>
</FONT></P>
                        <P STYLE="margin-bottom: 0.11in"><IMG SRC="view/common/user_admin/superadmin.png" NAME="Picture 12" ALIGN=BOTTOM WIDTH=602 HEIGHT=285 BORDER=0/></P>
...
<li style="font-family: Verdana;font-size: 17px !important;">Change image tab is used to change the avatars.</li></ul></SPAN></FONT></P>
                        <P STYLE="margin-bottom: 0.11in"><IMG SRC="view/common/user_admin/account1.png" NAME="Picture 16" ALIGN=BOTTOM WIDTH=601 HEIGHT=285 BORDER=0/>
                                                                                      
                        </P>
                        <P STYLE="margin-bottom: 0.11in"><IMG SRC="view/common/user_admin/account2.png" NAME="Picture 16" ALIGN=BOTTOM WIDTH=601 HEIGHT=285 BORDER=0/>
...
<ul>
  <li style="font-family: Verdana;font-size: 17px !important;">Help gives the user basic idea of the FreshGRC app.</li>
                        ...
                        <P STYLE="margin-bottom: 0.11in"><IMG SRC="view/common/user_admin/help.png" NAME="Picture 14" ALIGN=BOTTOM WIDTH=602 HEIGHT=338 BORDER=0></P>
...
<ul>
  <li style="font-family: Verdana;font-size: 17px !important;">There are three tabs in User Management at the bottom of the page.</li>
